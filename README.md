...
- [semgrep](docs/scanners/semgrep.md) - Execution of [`semgrep`](https://semgrep.dev) 0.59.0 which looks for semantic and syntactical patterns in code at the AST level.
