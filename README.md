...
- [semgrep](docs/scanners/semgrep.md) - Execution of [`semgrep`](https://semgrep.dev) 0.14.10 which looks for semantic and syntactical patterns in code at the AST level.
...
- [npm audit](docs/scanners/npm_audit.md) 6.13.7- Execution of [`npm audit`](https://docs.npmjs.com/getting-started/running-a-security-audit) which looks for CVEs in node module dependencies.
