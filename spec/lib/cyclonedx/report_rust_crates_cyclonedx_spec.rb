  ...
  describe "#run" do
    it 'should report all the deps in the Cargo.lock if manifest is absent in cyclonedx' do
      ...
      expect(rust_cyclonedx.build_components_object[0..2]).to match_array(
        [
          {
            "bom-ref": "pkg:cargo_lock/autocfg@0.1.7",
            "type": "library",
            "group": "",
            "name": "autocfg",
            "version": "0.1.7",
            "purl": "pkg:cargo_lock/autocfg@0.1.7",
            "properties": [
              {
                "key": "source",
          ...
          {
            "bom-ref": "pkg:cargo_lock/bitflags@1.2.1",
            "type": "library",
            "group": "",
            "name": "bitflags",
            "version": "1.2.1",
            "purl": "pkg:cargo_lock/bitflags@1.2.1",
            "properties": [
              {
                "key": "source",
                "value": "registry+https://github.com/rust-lang/crates.io-index"
          ...
          {
            "bom-ref": "pkg:cargo_lock/cloudabi@0.0.3",
            "type": "library",
            "group": "",
            "name": "cloudabi",
            "version": "0.0.3",
            "purl": "pkg:cargo_lock/cloudabi@0.0.3",
            "properties": [
              {
                "key": "source",
                "value": "registry+https://github.com/rust-lang/crates.io-index"
