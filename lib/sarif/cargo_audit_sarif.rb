  ...
  class CargoAuditSarif < BaseSarif
    ...
    def parse_issue(issue)
      ...
      parsed_issue = {
        ...
        messageStrings: {"package": {"text":"#{advisory['package']}"},
                         "title": {"text":"#{advisory['title']}"},
                         "severity": {"text":"#{advisory['cvss']}"},
                         "patched_versions": {"text":"#{issue.dig('versions','patched')}"},
                         "unaffected_versions": {"text":"#{issue.dig('versions','unaffected')}"}},
        uri: 'Cargo.lock',
