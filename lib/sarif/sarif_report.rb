...
module Sarif
  ...
  class SarifReport
    ...
    SARIF_SCHEMA = "https://schemastore.azurewebsites.net/schemas/json/sarif-2.1.0-rtm.5.json".freeze
    ...
    def to_sarif
      ...
      return JSON.pretty_generate(sarif_report)
    end
    ...
    def converter(scan_report)
      converter = Object.const_get("Sarif::#{scan_report.scanner_name[:scanner_name].capitalize}Sarif").new(scan_report)
