  ...
  class ReportNodeModules < Base
    ...
    def record_dependencies_from_latest_yarn_lock
      ...
      unless packages_shell_return.success?
        raise ParseError, "Failed to parse yarn.lock file: #{packages_shell_return.stderr}"
      end
      ...
      unless source_shell_return.success?
        raise ParseError, "Failed to fetch npmRegistryServer: #{source_shell_return.stderr}"
      end
