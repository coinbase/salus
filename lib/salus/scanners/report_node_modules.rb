    ...
    def record_dependencies_from_bower_json
      ...
      if @repository.bowerrc_present?
        ...
        if file.key?("registry")
          is_nested = file["registry"].is_a? String
          sources = is_nested ? file["registry"] : file["registry"]["search"].join(',')
        end
      end
      ...
      error_msg = "Failed to parse bower.json file when recording bower dependencies."
